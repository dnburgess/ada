...
function ecpt_admin_styles( $hook ) {
	...
	wp_enqueue_style('ecpt-admin', '/wp-content/themes/ada/assets/plugins/easy-content-types/includes/css/admin-styles.css');
	wp_enqueue_style('tooltip-css', '/wp-content/themes/ada/assets/plugins/easy-content-types/includes/css/thetooltip.css');
...
function ecpt_admin_scripts( $hook ) {
	...
	wp_enqueue_script('ecpt-admin', '/wp-content/themes/ada/assets/plugins/easy-content-types/includes/js/ecpt-admin.js', array('jquery'));
...
function ecpt_post_edit_styles() {
	...
	wp_enqueue_style('thickbox');
	wp_enqueue_style('ecpt-admin', '/wp-content/themes/ada/assets/plugins/easy-content-types/includes/css/admin-styles.css');
	wp_enqueue_style('datepicker-slider', '/wp-content/themes/ada/assets/plugins/easy-content-types/includes/css/datepicker-slider.css');
}
